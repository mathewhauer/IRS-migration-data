...
# Usage Notes
Any origin-destination pair with fewer than 10 tax filers over the entire period is excluded from the final datafile. This is done to reduce the size of the final datafile. 
